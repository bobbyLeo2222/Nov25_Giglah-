...
function TopBar({
  ...
  const unreadMessageBadge = unreadMessageCount > 99 ? '99+' : unreadMessageCount
                  ...
                  >
                    <span className="relative shrink-0">
                      <UserAvatar
                        ...
                        fallbackClassName="h-8 w-8 rounded-full bg-purple-100 text-purple-700"
                        fallbackTextClassName="text-xs font-semibold"
                      />
                      {unreadMessageCount > 0 && (
                        <span className="absolute -right-1 -top-1 min-w-[16px] rounded-full bg-purple-600 px-1 py-[1px] text-[9px] font-semibold leading-4 text-white ring-2 ring-white">
                          {unreadMessageBadge}
                        </span>
                      )}
                    </span>
            ...
            >
              <span className="relative flex h-9 w-9 items-center justify-center">
                <UserAvatar
                  ...
                  fallbackClassName="h-9 w-9 rounded-full bg-purple-100 text-purple-700"
                  fallbackTextClassName="text-sm font-semibold"
                />
                {unreadMessageCount > 0 && (
                  <span className="absolute -right-1 -top-1 min-w-[16px] rounded-full bg-purple-600 px-1 py-[1px] text-[9px] font-semibold leading-4 text-white ring-2 ring-purple-50">
                    {unreadMessageBadge}
                  </span>
                )}
              </span>
                ...
                <div className="flex items-center justify-between rounded-xl bg-slate-50 px-3 py-2">
                  <div className="flex items-center gap-3">
                    <span className="relative shrink-0">
                      ...
                      />
                      {unreadMessageCount > 0 && (
                        <span className="absolute -right-1 -top-1 min-w-[16px] rounded-full bg-purple-600 px-1 py-[1px] text-[9px] font-semibold leading-4 text-white ring-2 ring-slate-50">
                          {unreadMessageBadge}
                        </span>
                      )}
                    </span>
